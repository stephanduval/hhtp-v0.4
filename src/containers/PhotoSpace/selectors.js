...
export const makeSelectUserResponseArray = createSelector(
...
export const makesSelectCorrectResponseArray = createSelector(
  //'make* is a naming convention for selectors
  photoSpaceState, // get the global store state for state.homepage
...
export const makesSelectImageFilenameArray = createSelector(
  //'make* is a naming convention for selectors
  photoSpaceState, // get the global store state for state.homepage
