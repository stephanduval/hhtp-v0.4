...
import {
  checkForEmptyinArray,
  showMatchesOnly,
} from "../n-back-image-array/functions";
...
let CognitiveReappraisalArray =
  CRAConstant.randomizedCognitiveReappraisalArrayFileNameArray;

let resultCheckerArray = [
  {
    name: "Random Cognitive Reappraisal Array",
    arrayData: CognitiveReappraisalArray,
  },
];
