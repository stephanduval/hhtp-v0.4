...
const newCSVScoringDispatch = (dispatch) => ({
  newCSVScoringArray: (scoringArray) =>
    dispatch(newCSVScoringArray(scoringArray)),
});
...
const CognitiveReappraisalExamNavigation = () => {
  ...
  const { newCRAUserResponseArray } = setCRAUserResponseArrayDispatch(
    useDispatch()
  );
  ...
  const CSVDownloadStateRedux = useSelector(
    (state) => state.craNavigationReducer.CSVDownloaded
  );
  console.log("CRImageArrayFromRedux", CRImageArrayFromRedux);
  let ScoringArrayFromRedux = useSelector(
    (state) => state.cRImageArrayReducer.scoringArray
  );
      ...
      return (
        ...
        <div className="settings">
          <Button
            color="tertiary"
            variant="contained"
            stringvalue={"Start Cognitive Reappraisal Test"}
            onClick={() => {
              setRenderState(navigationPhaseTypes.introductionPage);
              console.log("clicked  cognitive reappraisal test start button");
            }}
          >
            Back
          </Button>
  ...
  const listItems = userResponseArray.map((number) => (
    <p>
      <li>{number}</li>
    </p>
  ));

  const listItemsFunction = (arrayParam) =>
          ...
          <form class="formFlex">
            <label class="radio-inline">
              <input
                ...
                onClick={() => {
                  howNegative = "1";
                  console.log("clicked 1", howNegative);
                }}
              />
              1
            </label>
            <label class="radio-inline">
              <input
                ...
                onClick={() => {
                  howNegative = "2";
                  console.log("clicked 2", howNegative);
                }}
              />
              2
            </label>
            ...
            <label class="radio-inline">
              <input
                ...
                onClick={() => {
                  howNegative = "4";
                  console.log("clicked 4", howNegative);
                }}
              />
              4
            </label>
            <label class="radio-inline">
              <input
                ...
                onClick={() => {
                  howNegative = "5";
                  console.log("clicked 5", howNegative);
                }}
              />
              5
            </label>
            <label class="radio-inline">
              <input
                ...
                onClick={() => {
                  howNegative = "6";
                  console.log("clicked 6", howNegative);
                }}
              />
              6
            </label>
            <label class="radio-inline">
              <input
                ...
                onClick={() => {
                  howNegative = "7";
                  console.log("clicked 7", howNegative);
                }}
              />
              7
            </label>
            <label class="radio-inline">
              <input
                ...
                onClick={() => {
                  howNegative = "8";
                  console.log("clicked 8", howNegative);
                }}
              />
              8
            </label>
            <label class="radio-inline">
              <input
                ...
                onClick={() => {
                  howNegative = "9";
                  console.log("clicked 9", howNegative);
                }}
              />
              9
            </label>
  ...
  function createScoringArrayFromfinalRandomizedCombinedCognitiveImagesArray(
    arrayParam
  ) {
    let newArray = [];
  ...
  let ScoringArray =
    createScoringArrayFromfinalRandomizedCombinedCognitiveImagesArray(
      CRImageArrayFromRedux
    );
  ...
  useEffect(() => {
    if (CRAViewState == CRImageArrayFromRedux.length) {
      ...
      CRImageArrayFromRedux[CRAViewState].slice(-8, -4) == "look" ||
      CRImageArrayFromRedux[CRAViewState].slice(-12, -4) == "decrease"
    ) {
  ...
  console.log(
    "current state",
    CRImageArrayFromRedux[CRAViewState],
    "Current CRI Index",
    CRAViewState
  );
  ...
  return (
    <div className="container">
      ...
      <div className="buttonSpace">
        <div>
          <p>CRI IMAGE ARRAY FROM REDUX</p>
          <p>CRImageArrayFromRedux</p>
          {listItemsFunction(CRImageArrayFromRedux)}
        </div>
        ...
        <div>
          <p>SCORING ARRAY</p>
          <p>ScoringArray</p>
          {listItemsFunction(ScoringArray)}
        </div>

        <div>
          <p>USER RESPONSE ARRAY</p>
          <p>userResponseArray</p>
          {listItemsFunction(userResponseArray)}
        </div>

        <div>
          <p>THE UGLIEST VARIABLE KNOWN TO MAN</p>
          <p>finalRandomizedCombinedCognitiveImagesArray</p>
          {listItemsFunction(finalRandomizedCombinedCognitiveImagesArray)}
        </div>
      </div>
    </div>
  );
