...
const cognitiveReappraisalExamNavigationState = (state) => state.cognitiveReappraisalExamNavigation;  // state.name matches the name used in combine reducers in store.js
