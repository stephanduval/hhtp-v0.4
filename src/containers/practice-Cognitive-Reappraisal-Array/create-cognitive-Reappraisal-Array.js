...
const decreaseImages = filesToPhotosObject(
  require.context(
    "./../../../public/images/practice-cognitive-reappraisal-photos/decrease/",
    false,
    /\.(png|jpe?g|svg)$/
  )
);
...
const decreaseFullFileNameArray = DecreaseImageFileNameArray.map(
  (e) => "./public/images/practice-cognitive-reappraisal-photos/decrease/" + e
);

const lookNegativeImages = filesToPhotosObject(
  require.context(
    "./../../../public/images/practice-cognitive-reappraisal-photos/look-negative/",
    false,
    /\.(png|jpe?g|svg)$/
  )
);
...
const lookNegativeFullFileNameArray = lookNegativeImagesFileNameArray.map(
  (e) =>
    "./public/images/practice-cognitive-reappraisal-photos/look-negative/" + e
);

const lookNeutralImages = filesToPhotosObject(
  require.context(
    "./../../../public/images/practice-cognitive-reappraisal-photos/look-neutral/",
    false,
    /\.(png|jpe?g|svg)$/
  )
);
...
const lookNeutralImagesFullFileNameArray = lookNeutralImagesFileNameArray.map(
  (e) =>
    "./public/images/practice-cognitive-reappraisal-photos/look-neutral/" + e
);

const titleCardImages = filesToPhotosObject(
  require.context(
    "./../../../public/images/practice-cognitive-reappraisal-photos/titlecards/",
    false,
    /\.(png|jpe?g|svg)$/
  )
);
...
export const titleCardImagesFullFileNameArray =
  titleCardImagesFileNameArray.map(
    (e) =>
      "./public/images/practice-cognitive-reappraisal-photos/titlecards/" + e
  );
...
const combinedCognitiveImagesArray = decreaseFullFileNameArray
  .concat(lookNegativeFullFileNameArray)
  .concat(lookNeutralImagesFullFileNameArray);
const randomizedPracticeCombinedCognitiveImagesArray =
  combinedCognitiveImagesArray.sort(() => 0.5 - Math.random());
const randomizedPracticeCombinedCognitiveImagesArrayWithTitleCards =
  addTitleCardsToCognitiveImagesArray(
    randomizedPracticeCombinedCognitiveImagesArray
  );
export const finalRandomizedPracticeCombinedCognitiveImagesArray =
  randomizedPracticeCombinedCognitiveImagesArrayWithTitleCards.map(
    (x) => "./" + x.slice(8)
  );
