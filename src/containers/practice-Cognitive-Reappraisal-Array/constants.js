...
export const ActionTypes = {
  ...
  CR_USER_RESPONSE_ARRAY:
    "app/containers/cognitive-Reappraisal-Array/USER_RESPONSE_ARRAY",
  CR_RENDER_VIEW: "app/containers/cognitive-Reappraisal-Array/RENDER_VIEW",
  CR_USER_ANSWER_TIME_ARRAY:
    "app/containers/cognitive-Reappraisal-Array/USER_ANSWER_TIME",
  CR_IMAGE_ARRAY: "app/containers/cognitive-Reappraisal-Array/CR_IMAGE_ARRAY",
};

const decreaseImagesObject = filesToPhotosObject(
  require.context(
...
const lookNegativeImagesObject = filesToPhotosObject(
  require.context(
...
const lookNeutralImagesObject = filesToPhotosObject(
  require.context(
...
const randomizedLookNegativeFileNameArray = lookNegativeFileNameArray.sort(
  () => 0.5 - Math.random()
);
const randomizedlookNeutralFileNameArray = lookNeutralFileNameArray.sort(
  () => 0.5 - Math.random()
);
...
const cognitiveReappraisalArrayFileNameArray = decreaseFileNameArray
  .concat(lookNegativeFileNameArray)
  .concat(lookNeutralFileNameArray);

const randomizedCognitiveReappraisalArrayFileNameArray =
  cognitiveReappraisalArrayFileNameArray.sort(() => 0.5 - Math.random());
